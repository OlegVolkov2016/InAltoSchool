...
public class ProjectDialog extends AnchorPane implements View {
	
	// Stage reference
	private Stage dialogStage;
	// Controller reference
	private ProjectDialogController controller;
	
	public ProjectDialog(Stage dialogStage) {
	...
	public void initLayout() {
		...
		loader.setRoot(this);
		controller = new ProjectDialogController();
	...
	public void changeLanguage() {
		// TODO Auto-generated method stub
		 dialogStage.setTitle(Strings.ProjectDialogTitle.getValue(Indexes.AppLanguage_index.getValue()));
	}
	
	// Getters
	public ProjectDialogController getController() {
		return controller;
	}
