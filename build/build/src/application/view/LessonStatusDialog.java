...
public class LessonStatusDialog extends AnchorPane implements View {
	
	// Stage reference
	private Stage dialogStage;
	// Controller reference
	private LessonStatusDialogController controller;
	
	public LessonStatusDialog(Stage dialogStage) {
	...
	public void initLayout() {
		...
		loader.setRoot(this);
		controller = new LessonStatusDialogController();
	...
	// Getters
	public LessonStatusDialogController getController() {
		return controller;
	}
