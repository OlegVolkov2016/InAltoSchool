...
public class ProjectTaskStatusDialog extends AnchorPane implements View {
	
	// Stage reference
	private Stage dialogStage;
	// Controller reference
	private ProjectTaskStatusDialogController controller;
	
	public ProjectTaskStatusDialog(Stage dialogStage) {
	...
	public void initLayout() {
		...
		loader.setRoot(this);
		controller = new ProjectTaskStatusDialogController();
	...
	// Getters
	public ProjectTaskStatusDialogController getController() {
		return controller;
	}
