...
public class CourseStatusDialogController {
	...
	public void changeLanguage () {
		...
		labelStudent.setText(Strings.LabelCourseStudent.getValue(Indexes.AppLanguage_index.getValue()));
	...
	public void setCourse(Course course) {
		this.course = course;
		textProjectAuthor.setText(course.getAuthor_name());
		textProjectName.setText(course.getCourse_name());
	}
