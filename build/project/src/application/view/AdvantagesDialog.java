...
public class AdvantagesDialog extends AnchorPane implements View {
	
	// Stage reference
	private Stage dialogStage;
	
	public AdvantagesDialog(Stage dialogStage) {
	...
	public void initLayout() {
		...
		loader.setRoot(this);
		AdvantagesDialogController controller = new AdvantagesDialogController();
