...
public class StudentDialog extends AnchorPane implements View {
	
	// Stage reference
	private Stage dialogStage;
	// Controller reference
	private StudentDialogController controller;
	
	public StudentDialog(Stage dialogStage) {
	...
	public void initLayout() {
		...
		loader.setRoot(this);
		controller = new StudentDialogController();
...
//		 dialogStage.setTitle(Strings.UserDialogTitle.getValue(Indexes.AppLanguage_index.getValue()));
	...
	// Getters
	public StudentDialogController getController() {
		return controller;
	}
