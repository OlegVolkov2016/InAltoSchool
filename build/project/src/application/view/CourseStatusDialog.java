...
public class CourseStatusDialog extends AnchorPane implements View {
	
	// Stage reference
	private Stage dialogStage;
	// Controller reference
	private CourseStatusDialogController controller;
	
	public CourseStatusDialog(Stage dialogStage) {
	...
	public void initLayout() {
		...
		loader.setRoot(this);
		controller = new CourseStatusDialogController();
	...
	// Getters
	public CourseStatusDialogController getController() {
		return controller;
	}
