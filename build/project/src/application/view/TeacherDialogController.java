...
public class TeacherDialogController {
	...
	public void changeLanguage () {
		labelFirstName.setText(Strings.TeacherLabelFirstName.getValue(Indexes.AppLanguage_index.getValue()));
		labelLastName.setText(Strings.TeacherLabelLastName.getValue(Indexes.AppLanguage_index.getValue()));
